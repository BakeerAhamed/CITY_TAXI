...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <a class="navbar-brand" href="#">
            <img src="./img/hero2.png" alt="City Taxi Logo" width="40" height="40" class="d-inline-block align-middle">
            City Taxi
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="taxiavailable.php">Taxi</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="Driverrequest.php">Pick Up</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="vehicleAvailability.php">Availability</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="bookingongoing.php">On Going</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="bookingHistory.php">Account</a>
